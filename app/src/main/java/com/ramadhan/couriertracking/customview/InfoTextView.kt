...
class InfoTextView(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    init {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            customInfoLabel.setTextColor(attributes.getColor(R.styleable.InfoTextView_labelColor,
                context.getColor(R.color.defaultTextColor)))
            customInfoValue.setTextColor(attributes.getColor(R.styleable.InfoTextView_valueColor,
                context.getColor(R.color.defaultTextColor)))
        }else{
            customInfoLabel.setTextColor(attributes.getColor(R.styleable.InfoTextView_labelColor,
